...
\usepackage[left=1.00cm, right=1.00cm, top=1.00cm]{geometry}
\begin{document}
	...
	\begin{tabular}{|p{3cm}||p{7cm}|p{7cm}|}
		...
		&&GUI: Startbildschirm-Activity (\cancel{Schließen}\footnote{Eine Schließen-Funktionalität, die die Applikation komplett schließt, scheint nicht notwendig zu sein, da das Android-OS bei Platzmangel den Prozess sowieso plattmacht und der User über den Task-Manager Apps schließen kann (http://android-developers.blogspot.de/2010/04/multitasking-android-way.html)}, Neue Sitzung, Sitzung laden), Sitzung-Erstellen-Activity, Spielstand-Anzeigen-Activity\\
		\hline
