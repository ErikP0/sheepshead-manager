...
public class DisplayScoresLandscape extends AbstractBaseActivity {
    ...
    protected void createUserInterface(Bundle savedInstanceState) {
        ...
        DynamicSizeTableBuilder tableBuilder = new DynamicSizeTableBuilder(new TableRow.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT, 1));
        tableBuilder.enableHeader();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVisible = true;
        mControlsView = findViewById(R.id.DisplayScoresLandscape_fullscreen_content_controls);
        mContentView = findViewById(R.id.DisplayScoresLandscape_fullscreen_content);
